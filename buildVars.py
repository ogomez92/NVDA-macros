...
addon_info = AddonInfo(
	...
	addon_summary=_("Macros"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	addon_description=_("""Record and replay keyboard macros in ten stacks of ten slots.
Press NVDA+alt+shift+m to enter the macros layer, then press shift plus a number to record,
a number to play, alt plus a number to edit the per-step speech safety checks,
or the left and right arrows to switch stacks.
Recordings keep the pauses between keystrokes and everything NVDA spoke,
and playback can be stopped as soon as NVDA's speech no longer matches what an enforced step expects."""),
	# version
	addon_version="1.0.0",
	# Brief changelog for this version
	# Translators: what's new content for the add-on version to be shown in the add-on store
	addon_changelog=_("""Initial release: record and play keyboard macros with timing,
recorded speech, macro stacks, and optional per-step wildcard speech safety checks."""),
	# Author(s)
	addon_author="Oscar Gomez <ogomez.s92@gmail.com>",
...
pythonSources: list[str] = ["addon/globalPlugins/macros/*.py"]
